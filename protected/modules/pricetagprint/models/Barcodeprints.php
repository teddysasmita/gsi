...
class Pricetagprints extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('papersize, pricetagtype', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, idatetime, regnum, papersize, paperwidth, paperheight, labelwidth, labelheight, pricetagtype, userlog, datetimelog', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('pricetagtype',$this->pricetagtype,true);
